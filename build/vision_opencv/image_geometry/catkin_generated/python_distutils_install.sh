...
echo_and_run cd "/home/wjy/CameraDriverWS/src/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/wjy/CameraDriverWS/build/vision_opencv/image_geometry \
    build --build-base "/home/wjy/CameraDriverWS/build/vision_opencv/image_geometry" \
    install \
    --root="${DESTDIR-/}" \
